webpackJsonp([3,10,14,16,17,26,27,28],[
/* 0 */
...
console.log('aaaaa');
//城市三级联动函数初始化
$.cxSelect.defaults.url = __webpack_require__(33);
$('#city').cxSelect({
    selects: ['province', 'city', 'area']

});
$('.fwClassRight ul li').click(function () {
    $('.fwClassRight ul li').css({ 'border': '1px solid #cccccc' });
    $('.fwClassRight ul li').children('span').remove();
    $(this).css({ 'border': '1px solid #d50000' }).append('<span></span>');
});
$('.refundRight ul li').click(function () {
    $('.refundRight ul li').css({ 'border': '1px solid #cccccc' });
    $('.refundRight ul li').children('span').remove();
    $(this).css({ 'border': '1px solid #d50000' }).append('<span></span>');
});
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
